Pod::Spec.new do |s|
    ...
    s.source       = { :http    => 'https://storage.googleapis.com/slang-ios-binary/cocoapods/ConvaOmniCopilot/1.22.15/ConvaOmniCopilot.zip'}
    s.vendored_frameworks = 'SlangOmni.xcframework', 'ConvaOmniCopilot.xcframework'
end
