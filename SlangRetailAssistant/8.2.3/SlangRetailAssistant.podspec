Pod::Spec.new do |s|
    ...
    # s.source       = { :http => 'file://' + '/Users/visvos07/Github/phabricator/polyglot/client/slang-ios-assistants/slang_retail_assistant/build/SlangRetailAssistant.zip'}
    s.source       = { :http    => 'https://storage.googleapis.com/slang-ios-binary/cocoapods/SlangRetailAssistant/8.2.3/SlangRetailAssistant.zip'}
