Pod::Spec.new do |s|
    ...
    # s.source       = { :http => 'file:' + '/Users/slanglabs-vishal/Downloads/phabricator/polyglot/client/slang-ios-assistants/slang_retail_assistant/build'}
    s.source       = { :http    => 'https://iosbinary.s3.ap-south-1.amazonaws.com/cocoapods/SlangRetailAssistant/6.0.1/SlangRetailAssistant.zip'}
